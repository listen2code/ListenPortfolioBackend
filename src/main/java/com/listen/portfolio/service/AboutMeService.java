...
public class AboutMeService {
    ...
    public AboutMeService(UserInfoRepository userInfoRepository) {
    ...
    public Optional<AboutMeResponse> getAboutMe() {
        ...
        long userId = 1L;
        Optional<UserInfoResponse> userInfoOptional = userInfoRepository.findById(userId);
        ...
        UserInfoResponse userInfo = userInfoOptional.get();
